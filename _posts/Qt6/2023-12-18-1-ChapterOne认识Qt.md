...
![Alt text](/assets/Qt6/ChapterOne/QtCreator简介.png)

### 1.3.2 新建一个GUI项目

![Alt text](/assets/Qt6/ChapterOne/SelectTemplate.png)

- Qt Widgets Application: 基于界面组件的应用，具有窗口的GUI程序
- Qt Console Appication: 控制台应用，没有GUI
- Qt Quick Application: 基于Qt Quick的应用，需要使用QML编程
- Qt Quick Application(Compat): 创建一个Qt Quick应用程序，其中包含一个空窗口。使用这个“compat”版本，如果你想使用其他构建系统比CMake或Qt版本低于6。

![Alt text](/assets/Qt6/ChapterOne/选择窗口基类.png)

- QMainWindow:主窗口类，具有菜单栏、工具栏和状态栏
- QWidget:所有界面组件类的基类
- QDialog:对话框类，窗口具有对话框的显示效果

![Alt text](/assets/Qt6/ChapterOne/选择构建套件.png)

### 1.3.3 项目的文件组成和管理

### 1.3.4 项目的构建、调试与运行

如果选择 `Shadow build`，构建后再项目的同级目录下创建一个输出文件夹，文件夹名称包含套件和构建模式信息。如果不勾选复选框，构建后的Qt Creator将在项目的目录下创建文件夹debug和release用于存放输出文件。

![Alt text](/assets/Qt6/ChapterOne/项目的构建.png)

![Alt text](/assets/Qt6/ChapterOne/选择ShadowBuild.png)

![Alt text](/assets/Qt6/ChapterOne/不选择ShadowBuild.png)
