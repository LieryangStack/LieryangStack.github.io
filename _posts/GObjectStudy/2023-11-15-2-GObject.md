...
有个示例程序在[/assets/GObjectStudy/202311/02_GObject/](/assets/GObjectStudy/202311/02_GObject/)目录里面，一个示例程序是example1.c，它的代码如下：
...
```
 ...
 ![请添加图片描述](/assets/GObjectStudy/202311/02_GObject/image/glib_tree.png)
...
![在这里插入图片描述](/assets/GObjectStudy/202311/02_GObject/image/share_class.png)
