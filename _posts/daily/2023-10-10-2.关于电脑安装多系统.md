...
- **GUID格式**：GPT（GUID Partition Table）分区表：GPT是一种现代的分区表格式，用于UEFI启动的硬盘和较新的计算机系统。它支持更多的分区，具有更大的分区容量，以及更强的数据完整性和安全性。
  ...
  ![Alt text](/assets/post/daily/20231010/image/image.png)
...
![Alt text](/assets/post/daily/20231010/image/image-1.png)

华硕主板里面的CSM支持，CSM支持的含义就是（兼容legacy+MBR启动模式）

![](/assets/post/daily/20231010/image/Screenshot%20from%202023-10-13%2010-19-18.png)
...
![Alt text](/assets/post/daily/20231010/image/image-2.png)

这个是UEFI运行流程：

![Alt text](/assets/post/daily/20231010/image/image-3.png)
