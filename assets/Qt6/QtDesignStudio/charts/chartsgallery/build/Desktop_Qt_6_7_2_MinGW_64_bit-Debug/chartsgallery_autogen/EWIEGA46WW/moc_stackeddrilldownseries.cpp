...
struct qt_meta_stringdata_CLASSStackedDrilldownSeriesENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSStackedDrilldownSeriesENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSStackedDrilldownSeriesENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject StackedDrilldownSeries::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSStackedDrilldownSeriesENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSStackedDrilldownSeriesENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSStackedDrilldownSeriesENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<StackedDrilldownSeries, std::true_type>
    >,
    nullptr
} };
...
void *StackedDrilldownSeries::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSStackedDrilldownSeriesENDCLASS.stringdata0))
