...
struct qt_meta_stringdata_CLASSLineWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSLineWidgetENDCLASS = QtMocHelpers::stringData(
    "LineWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLineWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject LineWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSLineWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLineWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLineWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<LineWidget, std::true_type>
    >,
    nullptr
} };
...
void *LineWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLineWidgetENDCLASS.stringdata0))
