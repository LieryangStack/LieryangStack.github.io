...
struct qt_meta_stringdata_CLASSPieWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPieWidgetENDCLASS = QtMocHelpers::stringData(
    "PieWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPieWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PieWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPieWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPieWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPieWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PieWidget, std::true_type>
    >,
    nullptr
} };
...
void *PieWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPieWidgetENDCLASS.stringdata0))
