...
namespace _0x5f_Test_MyItemControls_qml { 
...
Registry::Registry() {
    resourcePathToCachedUnit.insert(QStringLiteral("/Test/MyItemControls.qml"), &QmlCacheGeneratedCode::_0x5f_Test_MyItemControls_qml::unit);
