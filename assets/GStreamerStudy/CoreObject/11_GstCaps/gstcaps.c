...
/**
 * @name: gst_caps_new_empty
 * @call: gst_caps_init ()
 * @brief: 新建一个空白的#GstCaps。也就是说，返回的#GstCaps不包含媒体格式。保证#GstCaps是可写的。
*/
GstCaps *
...
/**
 * @name: gst_caps_new_any
 * @brief: 创建一个新的#GstCaps，表示它兼容任何媒体格式
 * @note: 设定的GstCaps的flags是GST_CAPS_FLAG_ANY
*/
GstCaps *
...
/**
 * @name: gst_caps_new_empty_simple
 * @param media_type: GstStructure的name，用来表示媒体类型，例如 "video/x-raw"
 * @brief: 创建一个新的#GstCaps，包含一个名称为@media_type类型的#GstStructure。
 * @note: media_type不能 "ANY"、"EMPTY"、"NONE"和""
*/
GstCaps *
