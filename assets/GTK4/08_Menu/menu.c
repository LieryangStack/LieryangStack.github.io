...
app_startup (GApplication *app) {
  ...
  g_menu_item_set_attribute (menu_item_quit, "double", "d", 1.5);
  ...
  g_menu_append_section (menu, "颜色", G_MENU_MODEL (section2));
  g_menu_append_section (menu, "退出", G_MENU_MODEL (section3));
  g_menu_append_submenu (menubar, "菜单", G_MENU_MODEL (menu));
