...
egl_thread_test_func (gpointer data) {
  ...
  GdkGLContext *context = gdk_surface_create_gl_context (gtk_native_get_surface (gtk_widget_get_native (widget)), NULL);
...
realize (GtkWidget *widget) {
  ...
  */
  ...
  GThread *egl_thread = g_thread_try_new ("test.egl.textrue", egl_thread_test_func, widget, NULL);
