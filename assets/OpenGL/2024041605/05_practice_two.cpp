/**
 * @brief: 尝试用不同的纹理环绕方式，设定一个从`0.0f`到`2.0f`范围内的（而不是原来的`0.0f`到`1.0f`）纹理坐标。试试看能不能在箱子的角落放置4个笑脸
*/
...
const char *vertexShaderSource = "#version 330 core\n"
    ...
    "   ourColor = aColor;\n"
    "   Tex1Coord = aTex1Coord;\n"
    "   Tex2Coord = aTex2Coord;\n"
    "}\0";
...
const char *fragmentShaderSource = "#version 330 core\n"
    ...
    "void main()\n"
    "{\n"
    "   FragColor = mix(texture(texture1, Tex1Coord), texture(texture2, Tex2Coord), 0.2);\n"
    "}\n\0";
...
main (int argc, char **argv) {
  ...
  float vertices[] = {
      // positions          // colors           // texture1  coords     //exture2  coords
